...
Ext.define('Ext.ux.ColumnAutoWidthPlugin', {
    ...
    refresh: function() {
        var me = this, grid = me.grid;
        if ( me.suspendAutoSize || !grid.rendered || !grid.getView().normalView.rendered ) return;
    ...
    getColumnResizers: function(column, config) {
        ...
        //Modificado por mi
        var els = this.grid.normalGrid.getEl().query( '.' + Ext.baseCSSPrefix + 'column-header[id='+column.id+']')
    ...
    doAutoSize: function( resizeCols ){
        ...
        Ext.batchLayouts(function(){
            ...
            me.grid.normalGrid.headerCt.el.addCls( squishCls );
            ...
            //modificado por mi
            me.grid.normalGrid.headerCt.el.removeCls( squishCls );
            Ext.each( tableResizers , function(el) {
